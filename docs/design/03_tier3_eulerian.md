...
*Prior specification on the source field $S$.*
...
| --- | --- | --- | --- |
| 1 | FV grid | [`les_fvm/grid.py`](https://github.com/jejjohnson/plumax/tree/main/src/plumax/les_fvm/grid.py) | ✓ |
| 1 | Advection | [`les_fvm/advection.py`](https://github.com/jejjohnson/plumax/tree/main/src/plumax/les_fvm/advection.py) | ✓ |
| 1 | Diffusion | [`les_fvm/diffusion.py`](https://github.com/jejjohnson/plumax/tree/main/src/plumax/les_fvm/diffusion.py) | ✓ |
