...
- :func:`open_multi_scene` — iterate over a sequence of scene files with
  ...
  :class:`~plumax.matched_filter.streaming.WelfordAccumulator`.
"""
...
def apply_image_xarray(
    ...
    *,
    ...
    mean, cov_op, target
        Same semantics as :func:`plumax.matched_filter.core.apply_image`.
    band_dim
...
def open_multi_scene(
    ...
    **open_kwargs,
    ...
    :class:`~plumax.matched_filter.streaming.WelfordAccumulator.update`.
