...
def streaming_background(
    ...
    *,
    ...
    pass the covariance through :func:`~plumax.matched_filter.core.apply_image`
    ...
    ddof
        ...
        :func:`~plumax.matched_filter.core.matched_filter_snr` and
        :func:`~plumax.matched_filter.core.detection_threshold`
