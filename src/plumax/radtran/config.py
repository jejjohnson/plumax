...
The forward models in :mod:`plumax.radtran.forward` need three
groups of inputs: atmospheric state (``T``, ``P``, background VMR), a
gas-species LUT (σ(ν, T, P), from :mod:`plumax.hapi_lut`), and
